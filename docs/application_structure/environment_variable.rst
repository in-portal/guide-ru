...
+-----------+---------------------------------------------------------------------------------------------------------+
| ``event`` | :doc:`Событие </event_description>`, которое требуется выполнить у данного :ref:`префикса <uc_Prefix>`. |
+-----------+---------------------------------------------------------------------------------------------------------+
...
.. note::
   ...
   ``kEvent::getPrefixSpecial()`` (для :doc:`событий </event_description>`) и ``TagProcessor:getPrefixSpecial()``
...
|    :type: string     |                                                                                              |
+----------------------+----------------------------------------------------------------------------------------------+
| .. config-property:: | Название :doc:`события </event_description>` для префикса ``cart``. Указанное событие        |
...
После успешного выполнения каждого :doc:`события </event_description>` происходит автоматическое перенаправление на шаблон,
