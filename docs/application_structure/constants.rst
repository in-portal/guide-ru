...
|    :name: BASE_PATH       | `$_SERVER['DOCUMENT_ROOT'] <https://www.php.net/reserved.variables>`__)                          |
|    :ref_prefix: const_    |                                                                                                  |
+---------------------------+--------------------------------------------------------------------------------------------------+
...
|                           | `$_SERVER['SERVER_NAME'] <https://www.php.net/reserved.variables>`__). В случае, если название   |
...
+---------------------------+--------------------------------------------------------------------------------------------------+
| .. config-property::      | Содержание констант :ref:`const_FULL_PATH` и :ref:`const_WRITEBALE_BASE` вместе.                 |
|    :name: WRITEABLE       |                                                                                                  |
|    :ref_prefix: const_    |                                                                                                  |
+---------------------------+--------------------------------------------------------------------------------------------------+
...
.. caution::
   ...
   Константы :ref:`const_WRITEABLE` и :ref:`const_WRITEBALE_BASE` неправильно названы. По английски они правильно
...
+------------------------+-------------------------------------------------------------------------+
 ...
 - статусы завершения :doc:`событий </database/table_structure/events>` в K4:
...
|    :ref_prefix: const_ |                                                                                                     |
+------------------------+-----------------------------------------------------------------------------------------------------+
| .. config-property::   | Проверка :doc:`прав доступа </database/table_structure/permissions>` не прошла успешно.             |
|    :name: erPERM_FAIL  | Автоматически будет выполнено перенаправление на шаблон сообщающий пользователю об отсутствии у     |
|    :ref_prefix: const_ | него прав на данное событие.                                                                        |
+------------------------+-----------------------------------------------------------------------------------------------------+
| .. config-property::   | Событие возвращает ответ в                                                                          |
|    :name: erSTOP       | :doc:`AJAX </administrative_console_interface/working_with_forms/working_with_ajax_requests>`       |
|    :ref_prefix: const_ | запрос. Шаблон не будет обработан после выполнения события, код отладчика тоже добавлен не будет.   |
+------------------------+-----------------------------------------------------------------------------------------------------+
...
+----------------------------------+---------------------------------------------------------------------------------+--------------------------------------------------+
| .. config-property::             | Значение, которое будет использоваться для объединения                          | ``||``                                           |
|    :name: VALUE_LIST_SEPARATOR   | :ref:`возможных опций <fmt_options>` в полях ``ValueList`` (во всех             |                                                  |
|    :ref_prefix: const_           | таблицах, кроме таблицы :doc:`/database/table_structure/configuration_admin`).  |                                                  |
+----------------------------------+---------------------------------------------------------------------------------+--------------------------------------------------+
...
|                                  | :ref:`const_REGEX_EMAIL_USER` и :ref:`const_REGEX_EMAIL_DOMAIN` можно составить |                                                  |
