...
:doc:`unit configs </components/unit_configs/config_files>` и к чему это приведёт.

.. toctree::
   :maxdepth: 1

   unit_configs/config_files
   unit_configs/class_registration
   unit_configs/table_field_description
