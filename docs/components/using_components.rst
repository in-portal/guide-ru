...
собой :doc:`набор полей для хранения информации и правил их обработки </components/unit_configs/config_files>`,
набор :doc:`тэгов </themes_and_templates/working_with_templates/basic_information_about_tags_and_templates>` специально
предназначенных именно для этого компонента, и так же специального набора :doc:`событий </events>`.
